...
4. [Функціональність](#4)<br>
    ...
    4.3.[Функціональність доступна адміністратору](#4-3)<br>

    4.4.[Функціональність доступна робітнику](#4-4)<br>
...
1. Менеджер проекту встановлює правила комунікації в проекті.
2. Система зберігає параметри.
3. Система формує план проекту.

<a name="3-4"></a>
**3.4.Сценарій зміни плану проекту**

*Передумови*: план проекту створений.

1. Менеджер проекту надсилає запит до системи щодо перегляду плану проекту.
2. Система надсилає план проекту.
3. Менеджер обирає пункт "Редагувати".
3. Менеджер проекту редагує поля які потребують змін.
4. Система зберігає параметри.
...
1. Користувач обирає пункт "Перегляд плану проекту" в інтерфейсі користувача.
...
*Виключні ситуації*: EX_1 Недостатні права для перегляду.
...
5. Система додає нового робітника до списку робітників.
...
4. Система надсилає повідомлення до підпорядованих робітників щодо нової задачі.
...
4. Система встановлює стан задачі на "Очікує ревьюєра".
...
5. Система вилучає задачу зі списку очікуючих задач.

<a name="3-11"></a>
**3.11.Сценарій виконання задачі**

*Передумови*: робітник закріплений як виконавець задачі.

1. Робітник відкриває інтерфейс виконання задачі.
...
6. Система надсилає повідомлення до ревьюєра задачі щодо очікування на підтвердження виконання задачі.

<a name="3-12"></a>
**3.12.Сценарій підтвердження виконання задачі**

*Передумови*: робітник закріплений як ревьюєр задачі.

1. Робітник обирає задачу із списку на огляд.
...
4. Створення задачі.
5. Закріплення виконання задачі.
6. Закріплення ревьюєра задачі.
7. Виконання задачі.
8. Підтвердження виконання задачі.
...
<a name="4-3"></a>
**4.3.Функціональність доступна адміністратору**

1. Додавання робітника.
2. Встановлення ієрархії робітників

<a name="4-4"></a>
**4.4.Функціональність доступна робітнику**

1. Створення задачі.
2. Закріплення виконання задачі.
3. Закріплення ревьюєра задачі.
4. Виконання задачі.
5. Підтвердження виконання задачі.
